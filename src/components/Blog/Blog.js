    ...
    <div className="bg-red-50 pt-20 pb-[350px]">
        ...
        >
          ...
          <div className="collapse-content">
            <p className="text-lg">
              ...
              components, which display the appropriate information. <br /><br />
      ...
      <div className="pt-5 w-4/5 mx-auto">
        ...
        >
          ...
          <div className="collapse-content">
            <p className="text-lg">
                <span>useRef() is a hook API of react. it accepts one argument as the initial value and returns a reference. A reference is an object having a special property current.</span> <br />
                <span>useRef returns a mutable ref object whose .current property is initialized to the passed argument (initialValue).</span><br />
